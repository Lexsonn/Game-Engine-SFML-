...
void Player::init() {
	...
	// IDLE ANIMATIONS //////////////////////////////////////////////////////
	animationList[idleE] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleE]->setRotation(270); 
	animationList[idleNE] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleNE]->setRotation(315);
	animationList[idleN] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true);
	animationList[idleNW] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleNW]->setRotation(45);
	animationList[idleW] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleW]->setRotation(90);
	animationList[idleSW] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleSW]->setRotation(135);
	animationList[idleS] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleS]->setRotation(180);
	animationList[idleSE] = new Animation(tx0, 0, 0, 50, 50, 4, 0.2, true); animationList[idleSE]->setRotation(225);
	// WALKING ANIMATIONS ///////////////////////////////////////////////////
	animationList[walkE] = new Animation(tx1, 0, 0, 48, 48, 8, 0.2, true); animationList[walkE]->moveOrigin(0, 7);
	animationList[walkNE] = new Animation(tx1, 0, 96, 48, 48, 8, 0.2, true); animationList[walkNE]->moveOrigin(0, 7);
	animationList[walkN] = new Animation(tx1, 0, 48, 48, 48, 8, 0.2, true); animationList[walkN]->moveOrigin(0, 7);
	animationList[walkNW] = new Animation(tx1, 0, 144, 48, 48, 8, 0.2, true); animationList[walkNW]->moveOrigin(0, 7);
	animationList[walkW] = new Animation(tx1, 0, 336, 48, 48, 8, 0.2, true); animationList[walkW]->moveOrigin(0, 7);
	animationList[walkSW] = new Animation(tx1, 0, 288, 48, 48, 8, 0.2, true); animationList[walkSW]->moveOrigin(0, 7);
	animationList[walkS] = new Animation(tx1, 0, 192, 48, 48, 8, 0.2, false); animationList[walkS]->moveOrigin(0, 7);
	animationList[walkSE] = new Animation(tx1, 0, 240, 48, 48, 8, 0.2, true); animationList[walkSE]->moveOrigin(0, 7);
	// RUNING ANIMATIONS ////////////////////////////////////////////////////
	animationList[runE] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runE]->setRotation(270);
	animationList[runNE] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runNE]->setRotation(315);
	animationList[runN] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true);
	animationList[runNW] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runNW]->setRotation(45);
	animationList[runW] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runW]->setRotation(90);
	animationList[runSW] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runSW]->setRotation(135);
	animationList[runS] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runS]->setRotation(180);
	animationList[runSE] = new Animation(tx2, 0, 0, 50, 50, 4, 0.2, true); animationList[runSE]->setRotation(225);
	// ATTACK BACKSWING ANIMATION ///////////////////////////////////////////
	animationList[ABSE] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSE]->setRotation(270);
	animationList[ABSNE] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSNE]->setRotation(315);
	animationList[ABSN] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false);
	animationList[ABSNW] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSNW]->setRotation(45);
	animationList[ABSW] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSW]->setRotation(90);
	animationList[ABSSW] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSSW]->setRotation(135);
	animationList[ABSS] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSS]->setRotation(180);
	animationList[ABSSE] = new Animation(tx3, 0, 0, 50, 50, 5, 0.2, false); animationList[ABSSE]->setRotation(225);
	// ATTACK 1 ANIMATIONS //////////////////////////////////////////////////
	animationList[attack1E] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1E]->setRotation(270);
	animationList[attack1NE] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1NE]->setRotation(315);
	animationList[attack1N] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false);
	animationList[attack1NW] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1NW]->setRotation(45);
	animationList[attack1W] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1W]->setRotation(90);
	animationList[attack1SW] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1SW]->setRotation(135);
	animationList[attack1S] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1S]->setRotation(180);
	animationList[attack1SE] = new Animation(tx4, 0, 0, 50, 50, 6, 0.2, false); animationList[attack1SE]->setRotation(225);
	// ATTACK 2 ANIMATIONS //////////////////////////////////////////////////
	// ATTACK RECOVER ANIMATIONS ////////////////////////////////////////////
	animationList[attRecE] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecE]->setRotation(270);
	animationList[attRecNE] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecNE]->setRotation(315);
	animationList[attRecN] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false);
	animationList[attRecNW] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecNW]->setRotation(45);
	animationList[attRecW] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecW]->setRotation(90);
	animationList[attRecSW] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecSW]->setRotation(135);
	animationList[attRecS] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecS]->setRotation(180);
	animationList[attRecSE] = new Animation(tx6, 0, 0, 50, 50, 6, 0.2, false); animationList[attRecSE]->setRotation(225);
	// DAMAGED ANIMATIONS ///////////////////////////////////////////////////
